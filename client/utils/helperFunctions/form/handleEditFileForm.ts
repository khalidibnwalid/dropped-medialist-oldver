...
export default function handleEditFileForm(file: string | UploadedImage | null | undefined, formData: FormData, filedName: string) {
    ...
    if (typeof file === "string") {
        ...
        // based on the what I made uploadImage form do on File deletion
        fileToAppend = deleteImageBlob
    } else {
        fileToAppend = (file as UploadedImage)?.[0]?.file
    }
