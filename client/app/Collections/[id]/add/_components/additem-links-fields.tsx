...
function AddLinksFields() {
    ...
    const { control, setValue, getValues, fieldTemplates, errors } = useContext(AddItemPageContext)
    const templates = fieldTemplates?.links

    const validateURLPattern = (value: string) => value.match(/^(ftp|http|https):\/\/[^ "]+$/i);


    return (
        <div className="grid grid-cols-1">
            <SortableFields fieldControl={control} fieldName='links'
