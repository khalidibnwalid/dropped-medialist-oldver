...
function CollectionMainInfoForm() {
    const { control, collectionData } = useContext(CollectionFormContext)
    ...
    const [isPinAllowed, setIsPinAllowed] = useState(() => {
        ...
        // typeof (collectionData?.pincode) === 'string' ? true : false
    })
...
export default CollectionMainInfoForm;
