...
function ListAdvancedSearch() {
    const { tags, advancedSearchVisability, usedTags, setUsedTags, setTagsQuery, tagsSearchOR, setTagsSearchOR } = useContext(listBodyContext)
        ...
        <AnimatePresence>
            {advancedSearchVisability && (
                <motion.div
                    ...
                    exit={{ height: 0 }}
                >
                    <Card className="grid gap-y-3 w-full py-3 mt-2 px-6 shadow-md bg-accented/40 animate-fade-in rounded-xl">
                        <p>Advanced Search</p>
